...
#     # print (endindex)
#     search_query_state = query_string
#     search_query_state['endindex'] = endindex
#     new_query_string = search_query_state
#     print("New query_string:", new_query_string)
#     encoded_qs = urlencode(new_query_string, doseq=1)
#     # new_url = f'https://api.queryly.com/cnbc/json.aspx?queryly_key=31a35d40a9a64ab3&query={query}&endindex={index}&batchsize=10&callback=&showfaceted=false&timezoneoffset=-240&facetedfields=formats&facetedkey=formats%7C&facetedvalue=!Press%20Release%7C&sort=date&additionalindexes=4cd6f71fbf22424d,937d600b0d0d4e23,3bfbe40caee7443e,626fdfcd96444f28'
#     new_url = f'https://api.queryly.com/cnbc/json.aspx?{encoded_qs}'
#     return new_url
