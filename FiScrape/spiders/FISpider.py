...
from FiScrape.items import FT_ArticleItem, convert_ft_dt, InsiderArticleItem, convert_bi_dt
...
class InsiderSpider(scrapy.Spider):
    ...
    def parse_article(self, response):
        ...
        loader.add_css('suummary', '#piano-inline-content-wrapper > div > div > ul ::text')
